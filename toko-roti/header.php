...
<html>
<head>
	<title>Fearent's Mille Crepes Delight</title>
		...
		<div class="row top">
			<center>
				<div class="col-md-4" style="padding: 3px;">
					<span> <i class="glyphicon glyphicon-earphone"></i> +6285872079798</span>
				</div>


				<div class="col-md-4"  style="padding: 3px;">
					<span><i class="glyphicon glyphicon-envelope"></i> fearentaurellia@gmail.com</span>
				</div>


				<div class="col-md-4"  style="padding: 3px;">
					<span>Fearent's Mille Crepes Delight</span>
				</div>
			</center>
		</div>
	</div>
	...
	<nav class="navbar navbar-default" style="padding: 5px;">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#" style="color: #ff8680"><b>Fearent's Mille Crepes Delight</b></a>
			</div>
